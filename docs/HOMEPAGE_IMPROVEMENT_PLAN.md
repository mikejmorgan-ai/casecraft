# CaseCraft Homepage Improvement Plan
...
- [ ] Add legal disclaimer text:
  - "CaseCraft is a simulation platform for educational and practice purposes only"
...
#### 2.6 New Animated Section - "How CaseCraft Works"
