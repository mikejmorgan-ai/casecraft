...
PACKET_INFO = {
    '1': ('DECLARATORY RELIEF', 'Ordinance Invalid -- Utah Code 17-41-402 Preemption',
          'Packet_1_Declaratory_Relief_Ordinance_Invalid.pdf'),
    '2': ('PERMANENT INJUNCTION', 'Stop County from Enforcing Invalid Ordinance',
          'Packet_2_Permanent_Injunction.pdf'),
    '3': ('DECLARATORY RELIEF -- VESTED MINING USE', 'Tree Farm Has a Vested Mining Use -- Utah Code 17-41-501 to -503',
          'Packet_3_Vested_Mining_Use.pdf'),
    '4': ('REGULATORY TAKING (ALTERNATIVE)', 'U.S. Const. Amend. V; Utah Const. Art. I Sec. 22',
          'Packet_4_Regulatory_Taking.pdf'),
    '5': ('COUNTY COUNTERCLAIM', '17-41-402(6)(1) Does Not Preempt the Ordinance',
