...
OUTPUT_PATH = "/home/user/casebreak/binder/VESTED_MINING_RESULTS.md"
...
def write_results(stats, key_findings, critical_docs, all_relevant, content_hashes, doc_type_counts=None):
    ...
    with open(OUTPUT_PATH, 'w') as f:
        ...
        f.write("> this claim's analysis because Claim 3 focuses on vested mining rights, not CIM\n")
