...
import { getCurrentPlaintiff, getCurrentDefendant, getPartyRouting } from '@/lib/case-ledger'
...
export const NAMESPACES = {
  ...
  'plaintiff-counsel': {
    ...
    'motions': 'Plaintiff motions',
    'briefs': 'Plaintiff legal briefs',
    'discovery-sent': 'Discovery requests TO Defendant',
    'discovery-responses': 'Responses TO Defendant discovery',
    'strategy-memos': 'Internal attorney work product',
    'affidavits': 'Plaintiff affidavits and declarations',
  },

  // Defense counsel
  'defense-counsel': {
    'answers': 'Defendant Answers, Counterclaims',
    'motions': 'Defendant motions',
    'briefs': 'Defendant legal briefs',
    'discovery-sent': 'Discovery requests TO Plaintiff',
    'discovery-responses': 'Responses TO Plaintiff discovery',
    'disclosures': 'Defendant initial/supplemental disclosures',
  },
...
export const DOCUMENT_ROUTING: Record<string, string | ((meta: DocumentMeta) => string)> = {
  ...
  // Answers
  answer: (meta) =>
    meta.filed_by === getCurrentPlaintiff()
      ? 'plaintiff-counsel--motions'
      : 'defense-counsel--answers',
