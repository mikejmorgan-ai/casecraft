...
import { createSecureSupabase } from './secure-client'

/**
 * Create a RLS-compliant Supabase client.
 * SECURITY: Uses anon key with user context - respects Row Level Security policies
 */
export async function getSupabase() {
  return await createSecureSupabase()
}
