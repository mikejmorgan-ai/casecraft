...
export function HearingRunner({
  ...
  const downloadTranscript = () => {
    ...
    content += `${'='.repeat(60)}\n\n`
    content += `Case: ${getCurrentPlaintiff()} v. ${getCurrentDefendant()}\n`
    content += `Case No: ${caseManager.getCurrentCase()?.caseNumber || 'Unknown'}\n`
    ...
    content += `Generated by CaseBrake.ai AI Legal Simulation Platform\n`
